...
def rd(username=None):
    filenname = "/root/vina/demo/static/dv/%s/result.txt"%username
    out = open(filenname)
    line = out.readline()
    a = []
    l = []
    ...
    out.close()
####################################################
    filenname = "/root/vina/demo/static/dv/%s/listresult.txt"%username
    out = open(filenname)
    line = out.readline()
    li = []
    l = []
...
####################################################
    ...
    filenname = "/root/vina/demo/static/dv/%s/Lin.txt"%username
    out = open(filenname)
    line = out.readline()
    l = []
    i = 0
    ...
    out.close()
####################################################
    filenname = "/root/vina/demo/static/dv/%s/labeldata.txt"%username
...
def writetop(top,labelfile,username=None):
    ...
    nfile.save("/root/vina/demo/static/dv/%s/top.xls"%username)
def writeleast(least,labelfile,username=None):
    ...
    nfile.save("/root/vina/demo/static/dv/%s/least.xls"%username)
...
def readnodes(user=None):
    filename="/root/vina/demo/static/dv/%s/nodes.xls"%user
...
def readcommunity(username=None):
    filename="/root/vina/demo/static/dv/%s/communites.xls"%username
    filename=filename.encode('utf-8')
    fname = filename
    bk = xlrd.open_workbook(fname)
    sh = bk.sheet_by_name("sheet1")
...
def readtop(username=None):
    filename="/root/vina/demo/static/dv/%s/top.xls"%username
    filename=filename.encode('utf-8')
    fname = filename
    bk = xlrd.open_workbook(fname)
    sh = bk.sheet_by_name("sheet1")
...
def readleast(username=None):
    filename="/root/vina/demo/static/dv/%s/least.xls"%username
    filename=filename.encode('utf-8')
    fname = filename
    bk = xlrd.open_workbook(fname)
    sh = bk.sheet_by_name("sheet1")
